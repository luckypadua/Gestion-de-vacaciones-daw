...
`daw/rules/commits.instructions.md` requires one of two trailers on any commit
...
That rule applied to every repository DAW is installed in and to nothing here,
